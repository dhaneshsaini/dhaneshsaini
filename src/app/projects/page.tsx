...
export const project_data = [
  {
    ...
    slug: "weather-app",
    thumb: "weather.png",
    description: "A React-based app that displays current weather information using an API.",
  ...
  },
  {
    ...
    description: "A Progressive Web App (PWA) to track expenses, built with React.",
  ...
  },
  {
    ...
    slug: "portfolio",
    thumb: "porfolio.png",
    description: "Personal portfolio website showcasing projects and skills, created with NextJS and TypeScript.",
  ...
  },
  {
    ...
    description: "A Digital marketing website for brandingpioneers built with React.",
  ...
  },
  {
    ...
    description: "A simple sticky notes app for taking quick notes, built with React.",
  ...
  },
  {
    ...
    slug: "quiz-app",
    thumb: "quizapp.png",
    description: "A quiz application for testing knowledge, developed using React.",
